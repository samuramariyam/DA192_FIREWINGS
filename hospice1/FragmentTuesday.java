...
public class FragmentTuesday extends Fragment implements View.OnClickListener {
    View v;
    Button b;
    int id=0,selected=0;
    ViewGroup layout;
    ...
    public FragmentTuesday(String uid,String depid,String drid) {
        this.uid=uid;
        this.depid=depid;
        this.drid=drid;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        db.collection("/Hospital/"+uid+"/Departments/"+depid+"/Dr_List/"+drid+"/schedules/ctue/slots").orderBy("index").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
