...
public class ClinicTabs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clinic_tabs);
        ...
        Toast.makeText(ClinicTabs.this,c, Toast.LENGTH_SHORT).show();
    ...
    public void load(String cs){
        adapter.AddFragment(new ClinicFragMON(),"MON");
        adapter.AddFragment(new ClinicFragTUE(),"TUE");
       // adapter.AddFragment(new FragmentWednesday(),"WED");
